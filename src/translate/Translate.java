...
public class Translate implements TranslateVisitor {
	...
	public Exp visit(ClassDeclSimple n) {
		currClass=n.i.s; 
		symbolTable.beginScopeClass(Symbol.symbol(n.i.s));
	...
	public Exp visit(VarDecl n) {
		...
		symbolTable.addVariableAccess(Symbol.symbol(n.i.s), exp);
		return exp;
	}

	public Exp visit(MethodDecl n) {
		Stm varDeclStm = null, stm = null;
		symbolTable.beginScopeMethod(symbolTable.getMethod(n));
	...
	private Exp getAccess(Symbol s) {
		return symbolTable.lookUpAccess(s);
	}
